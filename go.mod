...
require (
	...
	github.com/stolostron/go-template-utils/v6 v6.2.1-0.20240918185130-f3fb5d870999
	github.com/stolostron/kubernetes-dependency-watches v0.9.2-0.20240918155814-3a67a6be1808
